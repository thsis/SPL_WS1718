...
\lstinputlisting[language=R, firstline=122, lastline=135]{LDA/utils.R}
}

\frame{
\frametitle{Choose Starting Point}
\lstinputlisting[language=R, firstline=140, lastline=146]{LDA/utils.R}
}

\frame{
\frametitle{Update Starting Point $a$}
\lstinputlisting[language=R, firstline=152, lastline=163]{LDA/utils.R}
}
