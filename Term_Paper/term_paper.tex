...
\begin{figure}[h]
\caption{Correlation Matrix \bscaption{https://github.com/thsis/SPL_WS1718/blob/master/CART/cart_modell_fin.R}{cart\_modell\_fin.R}}
\centering
...
\begin{figure}
\caption{Variable Importance - varImp() function \bscaption{https://github.com/thsis/SPL_WS1718/blob/master/CART/cart_modell_fin.R}{cart\_modell\_fin.R}}
...
\lstinputlisting[language=R, escapechar=|, caption={|\textbf{\href{https://github.com/thsis/SPL_WS1718/blob/master/BRM/unit_tests.R}{unit\_tests.R}}|}]{../BRM/unit_tests.R}
