...
\lstinputlisting[language=R, firstline=19, lastline=21, firstnumber=19]{../Evaluation/Evaluate_Predictions.fin.R}
...
\lstinputlisting[language=R, firstline=24, lastline=47, firstnumber=24]{../Evaluation/Evaluate_Predictions.fin.R}
...
\lstinputlisting[language=R, firstline=49, lastline=106, firstnumber=49]{../Evaluation/Evaluate_Predictions.fin.R}
...
%Evaluation/ROC-Curve_CART.png
% Evaluation/ROC-Curve_Logit.png
% Evaluation/ROC-Curve_Random-forest.png 
...
\lstinputlisting[language=R]{../Preparation/data.preparation.R}
\subsubsection{BRM}
\lstinputlisting[language=R]{../BRM/utils.R}
\lstinputlisting[language=R]{../BRM/logit.R}
\subsubsection{Logit}
\lstinputlisting[language=R]{../Logit/logit_model_fin.R}
\subsubsection{CART}
\lstinputlisting[language=R]{../CART/CART_Modell.R}
\subsubsection{Random\_Forest}
\lstinputlisting[language=R]{../Random_Forest/random_forest_modell_fin.R }
\subsubsection{LDA}
\lstinputlisting[language=R]{../LDA/utils.R}
\lstinputlisting[language=R]{../LDA/lda.R}
\subsubsection{Evaluation}
\lstinputlisting[language=R]{../Evaluation/Evaluate_Predictions.fin.R}
