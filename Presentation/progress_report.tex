...
x9 & $\frac{Own funds - intangible assets}{total assets - intangible assets - cash and cash equivalents - lands and buildings}$ \\
...
\frametitle{Evaluate Predictions}
Plot ROC-Curve
\lstinputlisting[language=R, firstline=79, lastline=87]{Evaluate_Predictions_presentation.R}
}
