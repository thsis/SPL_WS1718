...
\begin{itemize}
\item Härdle, Prastyo, Hafner: Support Vector Machines with Evolutionary Feature Selection for Default Prediction
\item Härdle, Zhang: The Bayesian Additive Classification Tree applied to credit risk modelling
\item Härdle, Chen: Modeling default risk with support vector
machines
